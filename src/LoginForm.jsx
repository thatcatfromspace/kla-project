...
export const LoginForm = () => {
  ...
  return (
    <div onSubmit={handleSubmit(onSubmit)} className="login-back bg-slate-700 w-full h-screen justify-end min-h-64 flex">
      <form className="login-form rounded-lg shadow-lg min-h-[450px] py-3 px-3 w-64 my-52 bg-slate-200 me-20">
        <label className="flex justify-center pt-2 font-bold" htmlFor="continue-with"> Continue with </label>
        <div className="login-icons flex justify-evenly px-5">
          <Link to="https://github.com"><img src="" /></Link>
        </div>
        ...
        <div className="flex justify-center py-5">
          <button type="submit" class="text-white bg-gradient-to-br from-yellow-200 to-pink-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2">Login</button>
        </div>
