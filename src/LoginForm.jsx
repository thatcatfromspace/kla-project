    ...
    <div onSubmit={handleSubmit(onSubmit)} className="login-back bg-slate-700 w-full h-screen justify-end min-h-64 flex">
      <form className="login-form min-h-[50vh] h-[50vh] py-3 px-3 w-72 my-52 me-20">
        ...
        <div className="flex flex-col px-2 pt-2 pb-4">
          ...
          <div>
            <input type={toggleValue? "text": "password"} id="password-input" className="text-sm w-64 px-2 h-10 bg-gray2 rounded-md outline-none focus:outline-primary focus:border-0 me-2 absolute" required {...register("password")}></input>
        ...
        <div className="flex justify-center py-5">
          <button type="submit" className="text-white bg-gradient-to-br from-gray0 to-gray1 hover:bg-gradient-to-bl focus:ring-4 outline-none focus:outline-none font-medium rounded-full text-md px-5 py-2.5 text-center mr-2 mb-2">Login</button>
        </div>
