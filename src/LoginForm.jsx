...
export const LoginForm = () => {
  ...
  return (
    ...
    <div className="login-back flex w-[45vw] me-[15vw] min-w-[300px] h-screen justify-end min-h-3/4">
      <form onSubmit={handleSubmit(onSubmit)} className="login-form w-full min-h-1/2 h-1/2 py-3 px-3 my-auto max-w-[300px] border border-gray-500">
        <div className="text-center text-4xl"> SIGN IN </div>
        <div className="flex flex-col justify-center mt-8">
          <input type="email" className="bg-gray2 rounded-2xl h-12 px-4 text-md placeholder:text-gray-500" placeholder="Username" {...register("email")}></input>
        </div>
        <div className="flex flex-col justify-center mt-8">
          <input className="bg-gray2 rounded-2xl h-12 px-4 text-md placeholder:text-gray-500" placeholder="Password"></input>
        </div>
      </form>
    </div>
    </div>
